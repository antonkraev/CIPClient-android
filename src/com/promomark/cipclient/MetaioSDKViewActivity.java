...
{    
	...
	public void onCreate(Bundle savedInstanceState) 
	{
		...
		try
		{
			...
			final String signature = "S6jwT2SNeySgDDtAxQ3NEEsNv6FInYToi4XQmzCd7G0=";
...
//				mCameraResolution = metaioSDK.startCamera(0, 640, 480, 2);
	...
	{
		MetaioDebug.log("MetaioSDKViewActivity.doResume()");
	...
	{
		MetaioDebug.log("MetaioSDKViewActivity.doStop()");
